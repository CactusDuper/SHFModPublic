...
{
public:
	class FName                                   Category;                                          // 0x01F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   KernelName;                                        // 0x01F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FOptimusExecutionDomain                ExecutionDomain;                                   // 0x0200(0x0020)(NativeAccessSpecifierPublic)
...
{
public:
	struct FOptimusDataTypeRef                    DataType;                                          // 0x01F0(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
