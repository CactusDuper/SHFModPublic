...
#include "BP_Pl_Hina_SFX_classes.hpp"
#include "BP_Pl_Hina_SFX_parameters.hpp"
...
bool UBP_Pl_Hina_SFX_C::Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, const struct FAnimNotifyEventReference& EventReference) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Pl_Hina_SFX_C", "Received_Notify");

	Params::BP_Pl_Hina_SFX_C_Received_Notify Parms{};
...
void UBP_Pl_Hina_SFX_C::PlayVFX(class UMeshComponent* InMeshComp, EPhysicalSurface InSurfaceType, const struct FVector& InHitLocation, const struct FVector& InHitNormal) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Pl_Hina_SFX_C", "PlayVFX");

	Params::BP_Pl_Hina_SFX_C_PlayVFX Parms{};
