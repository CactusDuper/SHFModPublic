...
public:
	inline bool HasAnyFlags(int32 InFlags) const {
		return !!(int32(Flags) & InFlags);
	}
	static inline bool CheckObjectValidBasedOnItsFlags(const UObject* Test) {
		return !Test->HasAnyFlags(int32(EObjectFlags::MirroredGarbage));
	}
	inline bool IsValidChecked() const {
		return CheckObjectValidBasedOnItsFlags(this);
	}
	inline bool IsValid() const {
		return this && CheckObjectValidBasedOnItsFlags(this);
	}
	inline bool IsGarbage() const { // TODO: BROKEN
		return !!(int32(Flags) & int32(EInternalObjectFlags::Garbage));
	}
