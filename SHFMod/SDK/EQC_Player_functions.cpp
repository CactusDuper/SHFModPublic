...
#include "EQC_Player_classes.hpp"
#include "EQC_Player_parameters.hpp"
...
void UEQC_Player_C::ProvideSingleActor(class UObject* QuerierObject, class AActor* QuerierActor, class AActor** ResultingActor) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EQC_Player_C", "ProvideSingleActor");

	Params::EQC_Player_C_ProvideSingleActor Parms{};
