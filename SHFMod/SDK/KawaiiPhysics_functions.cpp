...
// Function KawaiiPhysics.KawaiiPhysicsLibrary.SetWarmUpFrames
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable)
// Parameters:
// const struct FKawaiiPhysicsReference&   KawaiiPhysics                                          (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
struct FKawaiiPhysicsReference UKawaiiPhysicsLibrary::SetWarmUpFrames(const struct FKawaiiPhysicsReference& KawaiiPhysics, int32 WarmUpFrames)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("KawaiiPhysicsLibrary", "SetWarmUpFrames");

	Params::KawaiiPhysicsLibrary_SetWarmUpFrames Parms{};
