...
public:
	...
	void BindToAnimationCompleted(class UWidgetAnimation* Animation, TDelegate<void()> Delegate);
	...
	void UnbindAllFromAnimationCompleted(class UWidgetAnimation* Animation);
	void UnbindAllFromAnimationFinished(class UWidgetAnimation* Animation);
	void UnbindAllFromAnimationStarted(class UWidgetAnimation* Animation);
	void UnbindFromAnimationCompleted(class UWidgetAnimation* Animation, TDelegate<void()> Delegate);
...
public:
	...
	uint8                                         bClassRequiresNativeTick : 1;                      // 0x0368(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bCanCallInitializedWithoutPlayerContext : 1;       // 0x0368(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_369[0x7];                                      // 0x0369(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FDelegateRuntimeBinding>        Bindings;                                          // 0x0370(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class UWidgetAnimation*>               Animations;                                        // 0x0380(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class FName>                           NamedSlots;                                        // 0x0390(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           AvailableNamedSlots;                               // 0x03A0(0x0010)(ZeroConstructor, AssetRegistrySearchable, NativeAccessSpecifierPublic)
	TArray<class FName>                           InstanceNamedSlots;                                // 0x03B0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	void SetApplyOutlineToDropShadows(const bool InDropShadows);
	void SetAutoWrapText(bool InAutoTextWrap);
	...
	void SetMinDesiredWidth(float InMinDesiredWidth);
	void SetOpacity(float InOpacity);
	void SetOutlineBlur(const int32 InBlur);
	void SetOutlineColor(const struct FLinearColor& InColor);
	void SetOutlineMaterial(class UMaterialInterface* InMaterial);
	void SetOutlineSize(const int32 InSize);
	void SetSeparateFillAlpha(const bool InSeperateAlpha);
