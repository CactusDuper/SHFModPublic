...
// const class FString&                    RTPC                                                   (Parm, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    BypassInternalValueInterpolation                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAkGameObject::SetRTPCValue(class UAkRtpc* RtpcValue, float Value, int32 InterpolationTimeMs, const class FString& RTPC, bool BypassInternalValueInterpolation) const
{
	static class UFunction* Func = nullptr;
...
void UAkGameplayStatics::SetRTPCValue(class UAkRtpc* RtpcValue, float Value, int32 InterpolationTimeMs, class AActor* Actor, class FName RTPC, bool BypassInternalValueInterpolation)
{
	static class UFunction* Func = nullptr;
