...
// Function BinkMediaPlayer.BinkMediaPlayer.SetNoceEnableFlag
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    IsEnable                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBinkMediaPlayer::SetNoceEnableFlag(bool IsEnable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BinkMediaPlayer", "SetNoceEnableFlag");

	Params::BinkMediaPlayer_SetNoceEnableFlag Parms{};
