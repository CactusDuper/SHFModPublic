...
public:
	...
	void SetRTPCValue(class UAkRtpc* RtpcValue, float Value, int32 InterpolationTimeMs, const class FString& RTPC, bool BypassInternalValueInterpolation) const;
...
public:
	...
	TMulticastInlineDelegate<void(bool bIsChecked)> AkOnCheckStateChanged;                           // 0x0F58(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FGuid& ItemDroppedID)> OnItemDropped;                 // 0x0F68(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class FString& PropertyDropped)> OnPropertyDropped;          // 0x0F78(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	static void SetRTPCValue(class UAkRtpc* RtpcValue, float Value, int32 InterpolationTimeMs, class AActor* Actor, class FName RTPC, bool BypassInternalValueInterpolation);
...
public:
	...
	float                                         ValueChangeDuration;                               // 0x02C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          BypassInternalValueInterpolation;                  // 0x02CC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
