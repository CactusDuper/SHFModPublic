...
#include "BP_Gimmick_SFX_classes.hpp"
#include "BP_Gimmick_SFX_parameters.hpp"
...
void UBP_Gimmick_SFX_C::PlayVFX(class UMeshComponent* InMeshComp, EPhysicalSurface InSurfaceType, const struct FVector& InHitLocation, const struct FVector& InHitNormal) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Gimmick_SFX_C", "PlayVFX");

	Params::BP_Gimmick_SFX_C_PlayVFX Parms{};
...
bool UBP_Gimmick_SFX_C::Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, const struct FAnimNotifyEventReference& EventReference) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Gimmick_SFX_C", "Received_Notify");

	Params::BP_Gimmick_SFX_C_Received_Notify Parms{};
